...
<%@page session="false"
        import="java.util.ArrayList,
                ...
                com.adobe.cq.commerce.demandware.ContentSlotTemplateService,
...
%><%@include file="/libs/granite/ui/global.jsp" %><%
    ...
    final ContentSlotTemplateService templatesService = sling.getService(ContentSlotTemplateService.class);

    final ArrayList<Resource> resourceList = new ArrayList<Resource>();
    if (templatesService != null) {
        Map<String, String> templates = templatesService.getTemplates();
        for (String template : templates.keySet()) {
            HashMap map = new HashMap();
            map.put("text", templates.get(template));
