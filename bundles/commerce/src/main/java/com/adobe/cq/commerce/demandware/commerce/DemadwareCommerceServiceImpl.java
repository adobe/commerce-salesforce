...
/**
 * Demandware specific implementation for the {@link DemadwareCommerceServiceImpl} interface.
 */
public class DemadwareCommerceServiceImpl extends AbstractJcrCommerceService implements CommerceService {

    private Resource resource;

    public DemadwareCommerceServiceImpl(ServiceContext serviceContext, Resource resource) {
    ...
    public CommerceSession login(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        return new DemandwareCommerceSessionImpl(this, request, response, resource);
    }
    ...
    public Product getProduct(String path) throws CommerceException {
        ...
        if (resource != null && DemandwareProductImpl.isAProductOrVariant(resource)) {
            return new DemandwareProductImpl(resource);
        }
        return null;
    }
