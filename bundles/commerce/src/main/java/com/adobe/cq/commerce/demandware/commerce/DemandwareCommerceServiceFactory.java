...
/**
 * Demandware specific implementation for the {@link CommerceServiceFactory} interface.
 */
@Component
@Service
@Properties(value = {
...
public class DemandwareCommerceServiceFactory extends AbstractJcrCommerceServiceFactory implements
        CommerceServiceFactory {

    @Override
    public CommerceService getCommerceService(Resource res) {
        return new DemadwareCommerceServiceImpl(getServiceContext(), res);
    }
}
